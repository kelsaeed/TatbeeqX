...
const MODULES = [
  ...
  { code: 'subsystems', name: 'Subsystems', icon: 'business', actions: ['view', 'manage'], menu: { label: 'Subsystems', route: '/subsystems', icon: 'business', sortOrder: 94 } },
...
const MENU_LABELS = {
  ...
  subsystems:       { en: 'Subsystems',        ar: 'الأنظمة الفرعية',  fr: 'Sous-systèmes' },
